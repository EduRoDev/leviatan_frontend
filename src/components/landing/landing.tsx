...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50 via-white to-purple-100 text-gray-900 overflow-x-hidden">
      ...
      <section
        ref={heroRef}
        className="relative min-h-screen pt-10 flex items-center justify-center px-6"
      >
        <motion.div
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              Learn smarter, not harder. Organize your materials and boost your
              productivity with AI support.
            </motion.p>
      ...
      <section ref={featuresRef} id="features" className="py-32 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-5xl font-bold mb-6 text-purple-700">
              {" "}
              Benefits
            </h2>
            <p className="text-xl text-gray-700 max-w-2xl mx-auto">
              Experience the future of learning with AI-powered tools designed
              to maximize your academic potential.
            </p>
          </motion.div>
      ...
      <section
        ref={pricingRef}
        id="pricing"
        className="py-32 px-6 bg-gradient-to-r from-purple-50 to-purple-100"
      >
        <div className="max-w-7xl mx-auto">
          <motion.div
            className="text-center mb-20"
          ...
          >
            ...
            <p className="text-xl text-gray-700 max-w-2xl mx-auto">
              Flexible pricing options designed to grow with your academic
              journey.
            </p>
          </motion.div>
                      ...
                      {plan.features.map((feature, idx) => (
                        <motion.li
                          ...
                          className={`flex items-center gap-3 ${
                            plan.popular ? "opacity-90" : "text-gray-700"
                          }`}
                          initial={{ opacity: 0, x: -20 }}
          ...
          {[1, 2, 3].map((i) => (
            ...
            >
              <p className="text-gray-700 italic">
                "This platform transformed my study habits. Totally recommend
                it!"
              </p>
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          >
            ...
            >
              ...
              study experience with AI-powered learning.
            </motion.p>
      ...
      <footer className="bg-purple-900 text-white py-16 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div className="space-y-4">
              <div className="text-2xl font-bold text-white">STUDY-AI</div>
              <p className="text-purple-200">
                Empowering students worldwide with AI-driven learning solutions.
              </p>
            </div>
            <div className="space-y-4">
          ...
          <div className="border-t border-purple-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-purple-200 text-sm">
              © 2025 LEVIATAN. All rights reserved.
            </p>
