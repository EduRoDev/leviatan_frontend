...
export function ViewDocument() {
  ...
  useEffect(() => {
    const fetchSummary = async () => {
      ...
      try {
        const response = await fetch(
          `${Enviroment.API_URL}/summary/resumen/${documentId}`,
          {
            method: "GET",
            headers: {
    ...
    const fetchFlashcards = async () => {
      try {
        const response = await fetch(
          `${Enviroment.API_URL}/cards/flash/${documentId}`,
          {
            method: "GET",
            headers: {
              Authorization: `Bearer ${token}`,
            ...
            <div className="space-y-6">
                  ...
                  {flashcards.length > 0 ? (
                    ...
                    >
                      ...
                      <p className="text-xs text-gray-400 mt-1">
                        Las flashcards aparecerán aquí cuando se generen
                      </p>
                    </motion.div>
                  )}
                </div>
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <button className="w-full px-3 py-2 text-left text-sm hover:bg-lavender rounded-lg transition-colors flex items-center text-gray-700 hover:text-primary">
                    <svg
