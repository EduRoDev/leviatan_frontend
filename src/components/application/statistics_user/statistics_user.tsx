        ...
        <div className="min-h-screen bg-gradient-to-br from-violet-50 via-white to-purple-50 p-6">
            <div className="max-w-7xl mx-auto">
                ...
                >
                    ...
                    <p className="text-gray-600">Tu progreso y desempeño en los quizzes</p>
                </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    ...
                    >
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm text-gray-600 mb-1">Quizzes Completados</p>
                                <p className="text-3xl font-bold text-gray-800">{statistics.total_quizzes}</p>
                            </div>
                    ...
                    >
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-3xl font-bold text-gray-800">{statistics.average_score.toFixed(2)}%</p>
                            </div>
                    ...
                    >
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-3xl font-bold text-gray-800">{statistics.best_score}%</p>
                            </div>
                    ...
                    >
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-3xl font-bold text-gray-800">{formatTime(statistics.total_time)}</p>
                            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                    ...
                    >
                        <h2 className="text-xl font-bold text-gray-800 mb-4">Evolución de Puntajes</h2>
                        <Chart
                            options={{
                                chart: {
                                    type: 'line',
                                ...
                                colors: ['#6D28D9'],
                                xaxis: {
                                    categories: statistics.recent_attempts.map((_, index) => `Intento ${index + 1}`),
                                    labels: {
                                        style: {
                                            colors: '#6B7280'
                                        }
                            ...
                            series={[
                                {
                                    name: 'Puntaje',
                                    data: statistics.recent_attempts.map(attempt => attempt.score)
                                }
                            ]}
                            type="line"
                            height={300}
                    ...
                    <motion.div
                        ...
                        className="bg-white rounded-xl shadow-lg p-6"
                    >
                        <h2 className="text-xl font-bold text-gray-800 mb-4">Distribución de Calificaciones</h2>
                        <Chart
                            options={{
                                chart: {
                                    type: 'donut'
                                },
                                labels: ['Excelente (≥70%)', 'Bueno (50-69%)', 'Necesita Mejorar (<50%)'],
                            ...
                            series={[
                                ...
                                statistics.recent_attempts.filter(a => a.score >= 50 && a.score < 70).length,
                    ...
                    <motion.div
                        ...
                        className="bg-white rounded-xl shadow-lg p-6"
                    >
                        <h2 className="text-xl font-bold text-gray-800 mb-4">Tiempo por Quiz</h2>
                        <Chart
                            options={{
                                chart: {
                                    type: 'bar',
                            ...
                            series={[
                                {
                                    name: 'Tiempo',
                                    data: statistics.recent_attempts.map(attempt => attempt.time_taken)
                                }
                            ]}
                            type="bar"
                            height={300}
                    ...
                    <motion.div
                        ...
                        className="bg-white rounded-xl shadow-lg p-6"
                    >
                        <h2 className="text-xl font-bold text-gray-800 mb-4">Comparación de Rendimiento</h2>
                        <Chart
                            options={{
                                chart: {
                                    type: 'radar',
                                ...
                                xaxis: {
                                    categories: ['Mejor Puntaje', 'Promedio', 'Peor Puntaje', 'Consistencia', 'Eficiencia'],
                                    labels: {
                                        style: {
                            ...
                            series={[
                                {
                                    ...
                                    data: [
                                        ...
                                        Math.max(0, 100 - Math.abs(statistics.best_score - statistics.average_score)),
                                        // Eficiencia: inverso del tiempo promedio normalizado (asumiendo max 10 minutos)
                                        Math.max(0, 100 - (statistics.total_time / statistics.total_quizzes / 600 * 100))
                                    ]
                                }
                            ]}
                            type="radar"
                ...
                <motion.div
                    ...
                    className="bg-white rounded-xl shadow-lg p-6"
                >
                    <h2 className="text-2xl font-bold text-gray-800 mb-4">Intentos Recientes</h2>
                    <div className="overflow-x-auto">
                        <table className="w-full">
                            <thead>
                                <tr className="border-b-2 border-gray-200">
                                    <th className="text-left py-3 px-4 text-gray-600 font-semibold">Intento</th>
                                    <th className="text-left py-3 px-4 text-gray-600 font-semibold">Quiz ID</th>
                                    <th className="text-left py-3 px-4 text-gray-600 font-semibold">Puntaje</th>
                                    <th className="text-left py-3 px-4 text-gray-600 font-semibold">Tiempo</th>
